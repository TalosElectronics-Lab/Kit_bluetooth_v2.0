...
char Kit_robot_bt::modo_bluetooth()
{
    int Estado;
...
Kit_robot_bt::~Kit_robot_bt()
{
}

char Kit_robot_bt::Leer_BT()
{
...
void Kit_robot_bt::modo_evasor(int Distancia, uint8_t velocidad)
{
...
float Kit_robot_bt::obtener_distancia()
{
    long lduration;
    long ldistance;
...
void Kit_robot_bt::modo_seguidor(float Kp, float Ki, float Kd, float Velocidad)
{
    leer_sensores();
    int velocidad_recta;
    P = Error;
...
void Kit_robot_bt::leer_sensores()
{
...
void Kit_robot_bt::print_sensores()
{
